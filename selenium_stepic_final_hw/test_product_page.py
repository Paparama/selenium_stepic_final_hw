...
class TestUserAddToCartFromProductPage(object):
    ...
    def open_page_and_add_product(self, browser, link):
        page = self.open_product_page(browser, link)
        page.add_to_basket()
        return page

    def open_product_page(self, browser, link):
    ...
    def test_user_can_add_product_to_cart(self, browser, link):
        page = self.open_page_and_add_product(browser, link)
    ...
    def test_user_cant_see_success_message_after_adding_product_to_cart(self, browser, link):
        page = self.open_page_and_add_product(browser, link)
    ...
    @pytest.mark.skip()
    @pytest.mark.parametrize('link', [product_city_and_the_stars_link])
    def test_user_cant_see_product_in_cart_opened_from_product_page(self, browser, link):
        page = ProductPage(browser, link)
        page.open()
        page.go_to_basket()
